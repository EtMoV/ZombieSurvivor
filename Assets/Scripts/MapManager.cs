...
public class MapManager : MonoBehaviour
{
    ...
    public GameObject openContainerMapNine_1;
    public GameObject openContainerMapNine_2;
    ...
    public GameObject openContainerMapEleven_1;
    ...
    public void Awake()
    {
        switch (StoreDataScene.currentMap)
        {
            ...
            case "mapNine":
                setMapByIndex(9);
                openContainerMapNine_1.SetActive(true);
            ...
            case "mapEleven":
                setMapByIndex(11);
                openContainerMapEleven_1.SetActive(true);
